...
describe('ArdoqClient', () => {
  ...
  it('createVcsHostingComponent cache exists', async () => {
    cache.set(ArdoqWorkspaceConfig.ARDOQ_VCS_HOSTING_WORKSPACE, 'github.com/jp', '91011');
    const client = new ArdoqClient(mockedAxios, cache);
  ...
  it('createCodeRepoComponent cache exists', async () => {
    cache.set(ArdoqWorkspaceConfig.ARDOQ_CODE_REPOSITORY_WORKSPACE, 'github.com/jp', '91011');
    const client = new ArdoqClient(mockedAxios, cache);
  ...
  it('getComponentIdIfExists cached', async () => {
    cache.set(ArdoqWorkspaceConfig.ARDOQ_SOFTWARE_FRAMEWORKS_WORKSPACE, 'fooComponent', '1234');
    const client = new ArdoqClient(mockedAxios, cache);
